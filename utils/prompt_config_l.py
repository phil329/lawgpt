...
# json Template
person_json_template="""{ "姓名": null, "性别": null, "出生日期": null, "民族": null, "住址": null, "联系方式": null, "身份证号": null, 委托诉讼代理人": { "姓名": null, "事务所": null } }"""
company_json_template="""{ "公司名称": None, "公司所在地": None, "法人": { "姓名": None, "职务": None, "联系方式": None},"委托诉讼代理人": {"姓名": None,"事务所": None}}"""
...
gudie_second_step0="""请根据以下内容判断案件类型（案件类型一般有机动车交通事故责任纠纷；民间借贷纠纷；离婚纠纷；合同纠纷；买卖合同纠纷；金融借款合同纠纷；借款合同纠纷；劳动争议；房屋买卖合同纠纷；建设工程施工合同纠纷，其他纠纷比如土地经营权纠纷等，请注意要以以下json格式输出案件类别{"案由":""}，我的输入是:"""
# 诉讼请求
...
# 证据
gudie_second_step3="""你是一名精通民事起诉的律师。请从下面客户输入的文字中提取客户说的证据内容"""
...
res_judge_no_2=["不继续","不用","没有了","否","是我自己","不需要","不要了","不添加了"]
